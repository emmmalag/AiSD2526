...
//rekurencyjny
vector<int> recursive_selector_sorted(const vector<Activity>& activities, int k) {
...
vector<int> recursive_selector_modded(const vector<Activity>& activities) {
    int n = activities.size();
    if (n == 0) return {};
...
//iteracyjny
vector<int> iterative_selector_modded(const vector<Activity>& activities) {
    int n = activities.size();
    if (n == 0) return {};
...
int main() {
    ...
    for (int k = 0; k < 5; k++) {
        ...
        for (int n : {5000, 10000, 15000, 20000, 25000, 30000, 35000, 40000, 45000, 50000, 55000, 60000, 65000, 70000, 75000, 80000, 85000, 90000, 95000, 100000}) {
            ...
            recursive_selector_modded(activities);
            ...
            iterative_selector_modded(activities);
